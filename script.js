...
function addProcess() {
    ...
    let rowHTML1 = `
                          ...
                          <td class="arrival-time" rowspan="2"><input id="d" type="number" min="0" step="1" value="0"> </td>
                      ...
                      `;
    let rowHTML2 = `
                           <td class="process-time cpu process-input"><input id="d" type="number" min="1" step="1" value="1"> </td>
                      `;
